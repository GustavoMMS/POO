 ...
 * @author Gustavo
 */
public class Mapa extends Acervo{
    ...
    public Mapa(String tamanhoPag, String autor1, String autor2, String titulo, String editora, String assunto, String palavraChave1, String palavraChave2, String cidade, String cdu, int ano, Integer id, int edicao, boolean emprestimo) {
    ...
    public boolean inserirBD() throws SQLException {
        ...
        String sql = "insert into mapa (id, autor1, autor2, titulo, edicao, cidade, editora, ano, emprestado, cdu, assunto, palavraChave1, palavraChave2)";
        sql += "values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public boolean alterarBD() throws SQLException {
        ...
        String sql = "update mapa set id=?, autor1=?, autor2=?, titulo=?, edicao=?, cidade=?, editora=?, ano=?, emprestado=?, cdu=?, assunto=?, palavraChave1=?, palavraChave2=?";
        sql += "where id=?";
    ...
    public static void getAllItens(ArrayList<Acervo> listAcervo) throws SQLException {
        ...
        while (rs.next()) {
            ...
            Acervo acervo = new Mapa(tipo, autor1, autor2, titulo, editora, assunto, palavraChave1, palavraChave2, cidade, cdu, ano, id, edicao, true);
