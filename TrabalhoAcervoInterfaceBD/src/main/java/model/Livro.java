...
public class Livro extends Acervo {
    ...
    public Livro(String isbn, String tamanhoPag, String autor1, String autor2, String titulo, String editora, String assunto, String palavraChave1, String palavraChave2, String cidade, String cdu, int ano, Integer id, int edicao, boolean emprestimo) {
    ...
    public void alterarDadosItem(String autor1, String autor2, String titulo, String editora, String assunto, String palavraChave1, String palavraChave2, String cidade, String cdu, int ano, Integer id, int edicao, boolean emprestimo, String isbn, String tamanhoPag) {
    ...
    public boolean inserirBD() throws SQLException {
        ...
        String sql = "insert into livro (id, autor1, autor2, titulo, edicao, cidade, editora, ano, pagina, emprestado, cdu, isbn, assunto, palavraChave1, palavraChave2)";
        sql += "values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public boolean alterarBD() throws SQLException {
        ...
        String sql = "update livro set id=?, autor1=?, autor2=?, titulo=?, edicao=?, cidade=?, editora=?, ano=?, pagina=?, emprestado=?, cdu=?, isbn=?, assunto=?, palavraChave1=?, palavraChave2=?";
        sql += "where id=?";
    ...
    public static void getAllItens(ArrayList<Acervo> listAcervo) throws SQLException {
        ...
        while (rs.next()) {
            ...
            Acervo acervo = new Livro(isbn, pagina, autor1, autor2, titulo, editora, assunto, palavraChave1, palavraChave2, cidade, cdu, ano, id, edicao, emprestado);
